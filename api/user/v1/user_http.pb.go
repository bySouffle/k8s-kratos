...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	...
	r.GET("/v1/user/create", _User_CreateUser1_HTTP_Handler(srv))
	r.POST("/v1/user/update", _User_UpdateUser0_HTTP_Handler(srv))
	r.GET("/v1/user/update", _User_UpdateUser1_HTTP_Handler(srv))
	r.POST("/v1/user/delete", _User_DeleteUser0_HTTP_Handler(srv))
	r.GET("/v1/user/delete", _User_DeleteUser1_HTTP_Handler(srv))
	r.POST("/v1/user/get", _User_GetUser0_HTTP_Handler(srv))
	r.GET("/v1/user/get", _User_GetUser1_HTTP_Handler(srv))
	r.POST("/v1/user/list", _User_ListUser0_HTTP_Handler(srv))
	r.GET("/v1/user/list", _User_ListUser1_HTTP_Handler(srv))
}
...
func _User_CreateUser1_HTTP_Handler(srv UserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in CreateUserRequest
...
func _User_DeleteUser1_HTTP_Handler(srv UserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in DeleteUserRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
...
func _User_ListUser1_HTTP_Handler(srv UserHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListUserRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
